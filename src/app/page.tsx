...
import { Camera, User, Store, X, ScanLine } from 'lucide-react';
...
export default function FoodieQRScanner() {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            {/* Background Decoration (Blobs) - Diperkecil sedikit opacity-nya */}
            ...
            <div className="w-full max-w-md relative z-10 flex flex-col h-full justify-center">
                ...
                {/* --- LOGO SECTION --- */}
                <div className="text-center mb-6"> {/* Margin bottom dikurangi dari mb-8 ke mb-6 */}
                    <div className="relative inline-block hover:scale-105 transition-transform duration-300">
                        {/* PERBAIKAN UKURAN: h-24 diubah menjadi h-12 (sekitar 48px) */}
                        <img 
                ...
                <div className="mb-8">
                    ...
                    <div className="grid grid-cols-5 gap-2"> {/* Gap diperkecil */}
                        {tables.map((table) => (
                            <button
                                key={table.id}
                ...
                {/* <div className="flex justify-center gap-3">
                    ...
                    <button 
                        ...
                        className="flex items-center gap-2 px-5 py-2.5 bg-white text-gray-600 rounded-full shadow-sm border border-gray-200 text-sm font-semibold hover:bg-green-50 hover:text-green-600 hover:border-green-200 transition-all"
                    >
