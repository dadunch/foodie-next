            ...
            <section className="p-4">
                ...
                <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                    <button
                        ...
                        className={`flex-shrink-0 px-6 py-3 rounded-xl border-2 transition-all ${selectedMerchant === ''
                    ...
                    {merchants.map((merchant) => (
                        <button
                            ...
                            className={`flex-shrink-0 px-6 py-3 rounded-xl border-2 transition-all ${selectedMerchant === merchant.nama_merchant.toString()
                                    ? 'bg-gradient-to-br from-green-600 to-green-400  text-white border-transparent shadow-lg'
                                    : 'bg-white text-gray-700 border-gray-200 hover:border-green-300'
                                }`}
                        >
